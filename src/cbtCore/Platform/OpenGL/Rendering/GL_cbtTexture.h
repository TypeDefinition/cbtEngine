...
NS_CBT_BEGIN
    ...
    public:
        ...
        virtual cbtTextureWrap GetWrapMode() const
        {
            return m_WrapMode;
        }

        virtual void Bind(cbtU32 _textureSlot)
        {
            glBindTextureUnit(_textureSlot, m_TextureName);
        }

        inline GLuint GetGLTextureName() const
        {
