...
NS_CBT_BEGIN
    ...
    cbtWindow* cbtWindow::CreateCBTWindow(const cbtWindowProperties& _properties)
    {
        return cbtNew SDL_cbtWindow(_properties);
    }
            ...
            :cbtWindow(_properties)
    {
        ...
        // Create Window
        m_SDL_Window = SDL_CreateWindow(m_Properties.m_Title.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
                m_Properties.m_Width, m_Properties.m_Height,
    ...
    void SDL_cbtWindow::SwapBuffers()
    {
