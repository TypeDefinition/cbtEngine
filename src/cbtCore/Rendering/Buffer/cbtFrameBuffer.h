...
NS_CBT_BEGIN
    ...
    public:
        ...
        static void ClearColor(cbtFrameBuffer* _frameBuffer, std::initializer_list<cbtU32> _attachmentIndices,
                cbtColor _color = cbtColor::BLACK);

        static void ClearDepth(cbtFrameBuffer* _frameBuffer,
                cbtF32 _depth = 1.0f); ///< If Depth Test is false, Clear Depth Buffer does not work.
        static void ClearDepthStencil(cbtFrameBuffer* _frameBuffer, cbtF32 _depth = 1.0f,
                cbtS32 _stencil = 0); ///< If Depth Test is false, Clear Depth Buffer does not work. If Stencil Test is false, Clear Stencil Buffer does not work.
        static void ClearStencil(cbtFrameBuffer* _frameBuffer,
                cbtS32 _stencil = 0); ///< If Stencil Test is false, Clear Stencil Buffer does not work.
        static void
        ClearAttachmentsAll(cbtFrameBuffer* _frameBuffer, cbtColor _color = cbtColor::BLACK, cbtF32 _depth = 1.0f,
                cbtS32 _stencil = 0);
