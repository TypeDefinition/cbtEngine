...
NS_CBT_BEGIN
    ...
    public:
        ...
        cbtColor(cbtF32 _r = 1.0f, cbtF32 _g = 1.0f, cbtF32 _b = 1.0f, cbtF32 _a = 1.0f)
        {
            Set(_r, _g, _b, _a);
        }

        cbtColor(const cbtColor& _other)
        {
            Set(_other.m_R, _other.m_G, _other.m_B, _other.m_A);
        }
        ...
        inline cbtF32 GetR() const
        {
            return m_R;
        }

        inline cbtF32 GetG() const
        {
            return m_G;
        }

        inline cbtF32 GetB() const
        {
            return m_B;
        }

        inline cbtF32 GetA() const
        {
            return m_A;
        }
