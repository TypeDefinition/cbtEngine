...
// Must use cbtS32. Binding a sampler2D uniform to an unsigned int texture index will result in failure.
    ...
    public:
        ...
        virtual void
        SetUniform(const cbtStr& _uniformName, cbtF32 _value0, cbtF32 _value1, cbtF32 _value2, cbtF32 _value3) = 0;
        ...
        virtual void
        SetUniform(const cbtStr& _uniformName, cbtS32 _value0, cbtS32 _value1, cbtS32 _value2, cbtS32 _value3) = 0;
        ...
        virtual void
        SetUniform(const cbtStr& _uniformName, cbtU32 _value0, cbtU32 _value1, cbtU32 _value2, cbtU32 _value3) = 0;
        ...
        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _value0, cbtBool _value1, cbtBool _value2, cbtBool _value3) = 0;
        ...
        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _transpose, const cbtMatrix<cbtF32, 3, 2>& _value) = 0;

        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _transpose, const cbtMatrix<cbtF32, 2, 3>& _value) = 0;

        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _transpose, const cbtMatrix<cbtF32, 2, 4>& _value) = 0;

        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _transpose, const cbtMatrix<cbtF32, 4, 2>& _value) = 0;

        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _transpose, const cbtMatrix<cbtF32, 4, 3>& _value) = 0;

        virtual void
        SetUniform(const cbtStr& _uniformName, cbtBool _transpose, const cbtMatrix<cbtF32, 3, 4>& _value) = 0;
        ...
        virtual void
        SetUniform(cbtU32 _uniformID, cbtBool _value0, cbtBool _value1, cbtBool _value2, cbtBool _value3) = 0;
        ...
        static cbtShaderProgram*
        CreateShaderProgram(const cbtStr& _name, const std::vector<cbtStr>& _vertexShaderSources,
