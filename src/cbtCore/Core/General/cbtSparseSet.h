...
*/
    ...
    class cbtSparseSet
    {
        ...
        */
        inline cbtS32 GetPage(cbtS32 _index) const
        {
            return _index / PARAGRAPH_COUNT;
        }
        ...
        */
        inline cbtS32 GetParagraph(cbtS32 _index) const
        {
            return _index % PARAGRAPH_COUNT;
        }
    ...
    public:
        ...
        */
        inline cbtU32 GetCount() const
        {
            return static_cast<cbtU32>(m_Items.size());
        }
