...
*/
    ...
    public:
        ...
        */
        ...
        static cbtMatrix<T, ROW_COUNT, COLUMN_COUNT>
        GetTransposeMatrix(const cbtMatrix<T, COLUMN_COUNT, ROW_COUNT>& _matrix)
        {
        ...
        */
        ...
        static cbtMatrix<T, MATRIX_SIZE - 1, MATRIX_SIZE - 1>
        GetMinorMatrix(const cbtMatrix<T, MATRIX_SIZE, MATRIX_SIZE>& _matrix, cbtU32 cofactorColumn,
                cbtU32 cofactorRow)
        {
        ...
        */
        template<typename T>
        static CBT_ENABLE_IF_FLOAT(T, T) GetDeterminant(const cbtMatrix<T, 2, 2>& _matrix)
        {
        ...
        */
        template<typename T>
        static CBT_ENABLE_IF_FLOAT(T, T) GetDeterminant(const cbtMatrix<T, 1, 1>& _matrix)
        {
            return _matrix[0][0];
        }
        ...
        */
        template<typename T>
        static CBT_ENABLE_IF_FLOAT(T, T) GetDeterminant(const cbtMatrix<T, 0, 0>& _matrix)
        {
        ...
        */
        template<typename T, cbtU32 MATRIX_SIZE>
        static cbtMatrix<CBT_ENABLE_IF_FLOAT(T, T), MATRIX_SIZE, MATRIX_SIZE>
        GetCofactorMatrix(const cbtMatrix<T, MATRIX_SIZE, MATRIX_SIZE>& _matrix)
        {
        ...
        */
        template<typename T, cbtU32 MATRIX_SIZE>
        static cbtMatrix<CBT_ENABLE_IF_FLOAT(T, T), MATRIX_SIZE, MATRIX_SIZE>
        GetAdjugateMatrix(const cbtMatrix<T, MATRIX_SIZE, MATRIX_SIZE>& _matrix)
        {
        ...
        */
        template<typename T, cbtU32 MATRIX_SIZE>
        static cbtMatrix<CBT_ENABLE_IF_FLOAT(T, T), MATRIX_SIZE, MATRIX_SIZE>
        GetInverseMatrix(const cbtMatrix<T, MATRIX_SIZE, MATRIX_SIZE>& _matrix)
        {
        ...
        */
        ...
        static cbtMatrix<CBT_ENABLE_IF_FLOAT(T, T), 4, 4> GetInverseMatrix(const cbtMatrix<T, 4, 4>& _matrix)
        {
            ...
            T determinant =
                    _matrix[0][0] * inverse[0][0] + _matrix[0][1] * inverse[0][4] + _matrix[0][2] * inverse[0][8] +
                            _matrix[0][3] * inverse[0][12];
        ...
        */
        static cbtMatrix4F
        GetOrthographicMatrix(cbtF32 _aspectRatio, cbtF32 _orthoSize, cbtF32 _nearPlane, cbtF32 _farPlane)
        {
        ...
        */
        static cbtMatrix4F
        GetViewMatrix(const cbtVector3F& _forward, const cbtVector3F& _up, const cbtVector3F& _position)
        {
