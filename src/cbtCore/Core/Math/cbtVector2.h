...
/// A cbtVector2 represents a vector with 2 components, X and Y.
    ...
    public:
        ...
        */
        cbtVector2(const cbtVector2& _other)
        {
            *this = _other;
        }
        ...
        */
        cbtBool operator==(const cbtVector2& _rhs) const
        {
        ...
        */
        ...
        /**
            ...
            \sa operator==(const cbtVector2&), operator!=(const cbtVector2&), operator=(const cbtVector2&),
                ...
                operator*(const T _scalar, const cbtVector2& _vector)
        */
        cbtVector2 operator+(const cbtVector2& _rhs) const
        {
            return cbtVector2(m_X + _rhs.m_X, m_Y + _rhs.m_Y);
        }
        ...
        */
        ...
        /**
            ...
            \sa operator==(const cbtVector2&), operator!=(const cbtVector2&), operator=(const cbtVector2&),
                ...
                operator*(const T _scalar, const cbtVector2& _vector)
        */
        cbtVector2 operator-() const
        {
            return cbtVector2(-m_X, -m_Y);
        }
        ...
        */
        ...
        /**
            ...
            \sa operator==(const cbtVector2&), operator!=(const cbtVector2&), operator=(const cbtVector2&),
                ...
                operator*(const T _scalar, const cbtVector2& _vector)
        */
        cbtVector2 operator*(const T _scalar) const
        {
            return cbtVector2(m_X * _scalar, m_Y * _scalar);
        }
        ...
        */
        ...
        /**
            ...
            \sa operator==(const cbtVector2&), operator!=(const cbtVector2&), operator=(const cbtVector2&),
                ...
                operator*(const T), operator*=(const T)
        */
        friend cbtVector2 operator*(const T _scalar, const cbtVector2& _vector)
        {
...
*/
    template<typename T>
    T LengthSquared(const cbtVector2<T>& _vector)
    {
        return _vector.m_X * _vector.m_X + _vector.m_Y * _vector.m_Y;
    }
...
*/
    template<typename T>
    CBT_ENABLE_IF_FLOAT(T, T) Length(const cbtVector2<T>& _vector)
    {
        return sqrt(LengthSquared(_vector));
    }
...
*/
    template<typename T>
    T Dot(const cbtVector2<T>& _vectorA, const cbtVector2<T>& _vectorB)
    {
        return _vectorA.m_X * _vectorB.m_X + _vectorA.m_Y * _vectorB.m_Y;
    }
