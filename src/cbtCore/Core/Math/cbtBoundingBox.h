...
*/
    ...
    public:
        ...
        */
        cbtBoundingBox(cbtF32 _minX = 0.0f, cbtF32 _minY = 0.0f, cbtF32 _minZ = 0.0f, cbtF32 _maxX = 0.0f,
                cbtF32 _maxY = 0.0f, cbtF32 _maxZ = 0.0f)
        {
        ...
        /**
            ...
            \return A cbtBoundingBox
        */
        cbtBoundingBox(const cbtVector3F& _min, const cbtVector3F& _max)
        {
            Set(_min, _max);
        }
        ...
        */
        cbtBoundingBox(const cbtBoundingBox& _other)
        {
            *this = _other;
        }
        ...
        */
        ...
        /**
            ...
            \param _max The maximum bounds of the bounding box.
        */
        void Set(const cbtVector3F& _min, const cbtVector3F& _max)
        {
            Set(_min.m_X, _min.m_Y, _min.m_Z, _max.m_X, _max.m_Y, _max.m_Z);
        }
        ...
        */
        inline const cbtVector3F& GetVertex(cbtU32 _index) const
        {
        ...
        */
        inline const cbtVector3F* GetVertices()
        {
            return &m_Vertices[0];
        }
        ...
        */
        inline cbtVector3F GetMin() const
        {
            return m_Min;
        }
        ...
        */
        inline cbtVector3F GetMax() const
        {
            return m_Max;
        }
        ...
        */
        inline cbtVector3F GetSize() const
        {
            return m_Max - m_Min;
        }
        ...
        */
        ...
        /**
            ...
            \return The nth vertex of the bounding box as specified by _index.
        */
        const cbtVector3F& operator[](cbtU32 _index) const
        {
            return m_Vertices[_index];
        }
        ...
        */
        cbtBool operator==(const cbtBoundingBox& _rhs) const
        {
            return (m_Max == _rhs.m_Max) && (m_Min == _rhs.m_Min);
        }
        ...
        */
        cbtBoundingBox& operator=(const cbtBoundingBox& _rhs)
        {
            m_Min = _rhs.m_Min;
            m_Max = _rhs.m_Max;
            for (cbtU32 i = 0; i < 8; ++i)
            { this->m_Vertices[i] = _rhs.m_Vertices[i]; }
            return *this;
        }
    };
