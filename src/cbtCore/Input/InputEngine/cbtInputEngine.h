...
NS_CBT_BEGIN
    ...
    protected:
        ...
        cbtInputEngine()
                :m_InputContext(CBT_INPUT_CONTEXT_DEFAULT)
        {
        }
    ...
    public:
        ...
        cbtInputContext GetContext()
        {
            return m_InputContext;
        }

        void SetContext(cbtInputContext _context)
        {
            m_InputContext = _context;
        }

        const cbtEventDispatcher* GetEventDispatcher() const
        {
            return &m_EventDispatcher;
        }

        cbtEventDispatcher* GetEventDispatcher()
        {
            return &m_EventDispatcher;
        }
    };
