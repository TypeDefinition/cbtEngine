...
public:
    ...
    */
    void Init(cbtECS _entity) { m_Entity = _entity; }
    ...
    */
    inline cbtECS GetEntity() const { return m_Entity; }
};
...
public:
    ...
    */
    void Remove(cbtECS _entity) { m_Remove(_entity); }
    /**
    ...
    */
    cbtBool Has(cbtECS _entity) const { return m_Has(_entity); }
    /**
        \brief Get the number of components in this pool.

        \return The number of components in this pool.
    */
    cbtU32 GetCount() const { return m_GetCount(); }
    ...
    */
    ...
    static cbtComponentPool* CreateComponentPool()
    {
        ...
        componentPool->m_Destructor = [componentPool](void) -> void
        {
            ...
            for (cbtU32 i = 0; i < sparseSet->GetCount(); ++i) { componentArray[i]->AutoRelease(); }
            delete sparseSet;
        };
...
public:
    ...
    */
    inline cbtU32 GetArraySize() const { return m_ArraySize; }
