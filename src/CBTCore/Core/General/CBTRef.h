...
public:
    ...
    */
    const T* GetRawPointer() const { return m_Managed; }
    ...
    /**
        ...
        \return The raw pointer of the pointed object.
    */
    T* GetRawPointer() { return m_Managed; }
    ...
    */
    cbtBool operator==(const T& _managed) const { return m_Managed == &_managed; }
    /**
        \brief Checks if this CBTRef is pointing to _managed.
        ...
        \return Returns true if pointing to _managed. Otherwise, returns false.
    */
    cbtBool operator==(const void* _managed) const { return m_Managed == static_cast<T*>(_managed); }
    ...
    */
    ...
    /**
        ...
        \return Returns false if pointing to _managed. Otherwise, returns true.
    */
    cbtBool operator!=(const void* _managed) const { return m_Managed != static_cast<const T*>(_managed); }
    ...
    /**
        ...
        \return The raw pointer of the pointed object.
    */
    const T* operator->() const { return m_Managed; }
    /**
        \brief Get the raw pointer of the pointed object.

        \return The raw pointer of the pointed object.
    */
    T* operator->() { return m_Managed; }
    /**
